...
const Students = () => {
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        setLoading(true)
        const res = await axiosAuth.get("https://turanapi2-001-site1.jtempurl.com/api/User/GetAllStudents/students")
  ...
  const handleDelete = async (student) => {
    ...
    if (result.isConfirmed) {
      try {
        await axiosAuth.delete(`https://turanapi2-001-site1.jtempurl.com/api/User/DeleteStudent/students/${student.id}`)
