...
const Parents = () => {
  ...
  useEffect(() => {
    const fetchParents = async () => {
      try {
        setLoading(true)
        const res = await axiosAuth.get("https://turansalimli-001-site1.ntempurl.com/api/User/parents")
  ...
  const handleDelete = async (parent) => {
    ...
    if (result.isConfirmed) {
      try {
        await axiosAuth.delete(`https://turansalimli-001-site1.ntempurl.com/api/User/parents/${parent.id}`)
